...
# ------
z1 = return_dict_seq2["z_mean"]
z2 = return_dict_seq1["z_mean"]

# z1[:, :, 6]  = copy.deepcopy(return_dict_seq2["z_mean"][:, :, 6])
# z1[:, :, 7]  = copy.deepcopy(return_dict_seq2["z_mean"][:, :, 7])
# z1[:, :, 12] = copy.deepcopy(return_dict_seq2["z_mean"][:, :, 12])

# z2[:, :, 6]  = copy.deepcopy(return_dict_seq1["z_mean"][:, :, 6])
# z2[:, :, 7]  = copy.deepcopy(return_dict_seq1["z_mean"][:, :, 7])
# z2[:, :, 12] = copy.deepcopy(return_dict_seq1["z_mean"][:, :, 12])

x_recon_z2_f1 = model.decode(z1, return_dict_seq1["f_mean"])
x_recon_z1_f2 = model.decode(z2, return_dict_seq2["f_mean"])
